...
drush dis -y liste_beskeder liste_frivillige_uden_email liste_m_cpr_nummer liste_parti_oversigt liste_valghalla_export liste_valghalla_kvittering locationmap valghalla_eboks valghalla_lists valghalla_notifications valghalla_signup valghalla_signup_list valghalla_sms valghalla_volunteer_validator valghalla_volunteers_import valghalla_volunteers_invite vcv_serviceplatformen vcv_person_lookup_extended vvv_validate_age field_ui views_ui imce panels_ipe panels_mini dashboard search contextual color contact valghalla_status_report
...
drush pmu locationmap valghalla_lists valghalla_notifications valghalla_signup valghalla_signup_list valghalla_volunteer_validator valghalla_volunteers_import valghalla_volunteers_invite vcv_serviceplatformen vcv_person_lookup_extended vvv_validate_age field_ui views_ui imce panels_ipe panels_mini dashboard search contextual color contact valghalla_status_report
